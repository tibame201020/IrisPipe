...
public class SyncJobFactory {
    ...
    public SyncJobFactory(JobRepository jobRepository, BatchBeanBuilder batchBeanBuilder,
            PlatformTransactionManager platformTransactionManager, ExecutionRecordService executionRecordService) {
    ...
    public Job createBatchJob(SyncJobContext syncJobContext) {
        ...
        SimpleJobBuilder simpleJobBuilder = new JobBuilder(syncJobContext.syncJob().getJobName(), jobRepository)
                .listener(new CustomJobListener(syncJobContext.destContext().getTransactionManager(), true, syncJobContext))
    ...
    private Step createInsertStep(SyncJobContext syncJobContext, SyncJobProp.Execution execution) {
        ...
        JdbcCursorItemReader<Map<String, Object>> jdbcCursorItemReader = batchBeanBuilder.creatJdbcCursorItemReader(
        ...
        return new StepBuilder(jobName + "_ insert_step", jobRepository)
                .listener(new ExecutionStepListener(syncJobContext, execution, executionRecordService))
                .<Map<String, Object>, Map<String, Object>>chunk(syncJobContext.syncJob().getSetting().batchSize(),
                ...
                .processor(item -> {
                    ...
                    if (StringUtils.isNotBlank(execution.watermarkColumn())) {
                        execution.executionContext()
                                .put(execution.watermarkColumn(), processItem.get(execution.watermarkColumn()));
                    }
    ...
    private Step createUpdateStep(SyncJobContext syncJobContext, SyncJobProp.Execution execution) {
        ...
        BatchUpdateWriter batchUpdateWriter = new BatchUpdateWriter(execution.destTable(), execution.summaryInfo(),
    ...
    private Step createUpsertStep(SyncJobContext syncJobContext, SyncJobProp.Execution execution) {
        ...
        BatchUpsertWriter batchUpsertWriter = new BatchUpsertWriter(
                insertWriter, updateWriter, sqlSyntaxHelper, syncJobContext.destContext().getJdbcTemplate(),
