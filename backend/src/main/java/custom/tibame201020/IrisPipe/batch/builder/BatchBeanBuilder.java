package custom.tibame201020.IrisPipe.batch.builder;
...
import custom.tibame201020.IrisPipe.utility.CollectionHelper;
...
public class BatchBeanBuilder {
    ...
    public JdbcCursorItemReader<Map<String, Object>> creatJdbcCursorItemReader(DataSource dataSource, String readerName,
            String querySql, List<SyncJobProp.Parameter> parameters, int fetchSize) {
