...
- [ ] `irispipe/infrastructure/config/BeanConfig.java` — Javadoc: `Class + public methods` — Test spec: `Covered indirectly`

## infrastructure.context

- [ ] `irispipe/infrastructure/context/DatabaseContext.java` — Javadoc: `Class only` — Test spec: `No direct test target`
- [ ] `irispipe/infrastructure/context/SyncJobContext.java` — Javadoc: `Class + public methods` — Test spec: `Covered indirectly`
...
- [ ] `irispipe/infrastructure/error/GlobalExceptionHandler.java` — Javadoc: `Class + public methods` — Test spec: `WebMvcTest`

## infrastructure.error.exception

- [ ] `irispipe/infrastructure/error/exception/ConfigFileException.java` — Javadoc: `Class only` — Test spec: `No direct test target`
- [ ] `irispipe/infrastructure/error/exception/ConfigValidationException.java` — Javadoc: `Class only` — Test spec: `No direct test target`
- [ ] `irispipe/infrastructure/error/exception/ConflictException.java` — Javadoc: `Class only` — Test spec: `No direct test target`
- [ ] `irispipe/infrastructure/error/exception/CustomJobExecutionException.java` — Javadoc: `Class only` — Test spec: `No direct test target`
- [ ] `irispipe/infrastructure/error/exception/ResourceNotFoundException.java` — Javadoc: `Class only` — Test spec: `No direct test target`

## infrastructure.provider

- [ ] `irispipe/infrastructure/provider/FileProvider.java` — Javadoc: `Class + public methods` — Test spec: `No direct test target`
- [ ] `irispipe/infrastructure/provider/JsonFileProvider.java` — Javadoc: `Class + public methods` — Test spec: `Mockito`
- [ ] `irispipe/infrastructure/provider/YamlFileProvider.java` — Javadoc: `Class + public methods` — Test spec: `Mockito`
...
- [ ] `irispipe/infrastructure/service/workspace/WorkspaceContextService.java` — Javadoc: `Class + public methods` — Test spec: `Mockito`
- [ ] `irispipe/infrastructure/service/workspace/WorkspaceService.java` — Javadoc: `Class + public methods` — Test spec: `Mockito`
